...
valid:                                        # Print the decimal value of the hex.
      ...
      addi $t1, $zero, 10000                  # Initialize t1 to 10000.  
      divu $s0, $t1                           # Divide out number by 10000.
      mflo $s1                                # Store the quotient in s1.
      mfhi $s2                                # Store the remainder in s2.
    
      beq $s1, $zero, rem_only                # If quotient is 0, then we will only print the remainder.
